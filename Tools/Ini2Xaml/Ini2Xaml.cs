...
{
    /// <summary> Provides logic to convert a theme INI file to a WPF-compatible ResourceDictionary (.xaml). </summary>
    static public class Ini2Xaml
    {
        // INI parser state to load theme properties
        static private readonly IINIState _iniState;

        /// <summary> Initializes the INI state with a dummy default path. Must be overridden via SetSourcePathProperty(). </summary>
        static Ini2Xaml()
        {
        ...
        /// <summary> Configures the input INI file path used for theme conversion. </summary>
        ...
        /// <summary> Converts the loaded INI data into a WPF XAML file. </summary>
