...
using SimpleOverlayTheme.Themes.ThemeProperty;
using System.ComponentModel;
using System.Runtime.CompilerServices;
using System.Windows;
using System.Windows.Media;

namespace SimpleOverlayTheme.Themes
{
    /// <summary>
    ...
    internal partial class Current : ICurrent
    {
        ...
        internal void Initialize()
        {
            ...
            var changedProperties = new List<string>() {
                ...
                nameof(FontSize_Default), nameof(Thickness_Default),
                nameof(ColorPalette_Foreground), nameof(ColorPalette_Foreground_Disable),
                nameof(ColorPalette_Background), nameof(ColorPalette_Outline),
            ...
            var changedDictionary = new Dictionary<string, object>() {
                ...
                { ThemeKey.Thickness.Default.Xaml, Thickness_Default },
