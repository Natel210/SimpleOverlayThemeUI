...
namespace SimpleOverlayTheme.CurrentThemeGeneraterToXaml
{
    ...
    static public class XamlConverter
    {
        ...
        static public bool Execute(FileInfo outputPath)
        {
            ...
            stringBuilder.AppendLine($"");
            stringBuilder.AppendLine($"    {formatSection(ThemeKey.Overlay.Border.Background.Active.Ini.Section)}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Background.Active, toHex(5, 128, 128, 128))}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Background.Default, toHex(16, 128, 128, 128))}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Background.Disable, toHex(37, 128, 128, 128))}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Background.MouseOver, toHex(64, 128, 128, 128))}");
            stringBuilder.AppendLine($"");
            stringBuilder.AppendLine($"    {formatSection(ThemeKey.Overlay.Border.Outline.Active.Ini.Section)}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Outline.Active, toHex(37, 128, 128, 128))}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Outline.Default, toHex(51, 21, 21, 21))}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Outline.Disable, toHex(128, 21, 21, 21))}");
            stringBuilder.AppendLine($"    {formatTickness(ThemeKey.Overlay.Border.Outline.MouseOver, toHex(255, 21, 21, 21))}");
            stringBuilder.AppendLine($"");
