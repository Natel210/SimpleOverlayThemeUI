...
namespace SimpleOverlayTheme.ThemeSystem.Specific
{
    public class OverlayMaskForeground : IThemeItem
    {
        internal static class BaceValue
        {
            ...
            public static Color Disable { get; } = Color.FromArgb(37, 21, 21, 21);
            public static Color Default { get; } = Color.FromArgb(80, 21, 21, 21); // Color.FromArgb(80, 15, 15, 15)
        ...
        {
            public static Color Disable { get; } = Color.FromArgb(37, 235, 235, 235);
            public static Color Default { get; } = Color.FromArgb(80, 235, 235, 235); // Color.FromArgb(58, 128, 128, 128)
            public static Color MouseOver { get; } = Color.FromArgb(160, 235, 235, 235);
            public static Color Active { get; } = Color.FromArgb(240, 235, 235, 235);
        }
