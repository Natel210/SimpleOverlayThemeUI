...
namespace SimpleOverlayTheme.ThemeSystem.Specific
{
    public class OverlayBoaderOutline : IThemeItem
    {
        internal static class BaceValue
        {
            ...
            public static Color Default { get; } = Color.FromArgb(51, 21, 21, 21);
            public static Color MouseOver { get; } = Color.FromArgb(128, 21, 21, 21);
            public static Color Active { get; } = Color.FromArgb(255, 21, 21, 21);
        }
